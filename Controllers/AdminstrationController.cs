  ...
  // [Authorize(Roles = "PayRolle")]
    ...
    public class AdminstrationController : Controller
    {
        ...
        public async Task<IActionResult> DeleteUser(string id)
        {
            ...
            if(user==null)
            {
                ViewBag.ErrorMessage = $"User eith id = {id} cannot be found";
                return View("NotFound");
            }
            else
            {
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                catch(DbUpdateException ex)
                {
                    ...
                    ViewBag.ErrorMessage = $"{role.Name} role cannot be deleted are users" +
        ...
        public async Task<IActionResult> ManageUserClaims(string userId)
        {
            ...
            foreach(Claim claim in ClaimsStore.AllClaims)
            {
                ...
                //if the user has the claim,set IsSelected property to true,so checkbox
